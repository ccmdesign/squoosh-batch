 ...
 */class Image {
  constructor(workerPool, file) { this.file = file; this.workerPool = workerPool; this.decoded = workerPool.dispatchJob({ operation: "decode", file }); this.encodedWith = {} }/**
 ...
 */class ImagePool {/**
   ...
   */async close() { await this.workerPool.join() }
} if (!worker_threads.isMainThread) { WorkerPool.useThisThreadAsWorker(handleJob) } exports.ImagePool = ImagePool; exports.encoders = codecs; exports.preprocessors = preprocessors;
